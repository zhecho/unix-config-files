" nvim configuration file ~/.config/nvim/init.vim
...
" Set filetype as javascript / javascriptreact file
...
verbose inoremap <silent><expr> <TAB>
      ...
      \ CheckBackspace() ? "\<Tab>" :
      \ coc#refresh()
verbose inoremap <expr><S-TAB> coc#pum#visible() ? coc#pum#prev(1) : "\<C-h>"

" Make <CR> to accept selected completion item or notify coc.nvim to format
" <C-g>u breaks current undo, please make your own choice.
verbose inoremap <silent><expr> <CR> coc#pum#visible() ? coc#pum#confirm()
